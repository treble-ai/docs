...
To access the agent platform, you must log in to Treble.ai and select the "Sales.ai" option in the navigation menu. If you want to access the agent platform directly, you can do so by going to <a class="article-link" href="https://sales.treble.ai"><p>https://sales.treble.ai</p><Icon icon="arrow-up-right-from-square" iconType="solid" /></a>. 