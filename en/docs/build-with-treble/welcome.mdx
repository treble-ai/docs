...
In the [Introduction to Treble](/en/docs/intro-to-treble/welcome) section, you learned about Treble's key concepts such as conversations, blocks, templates, and more. Now, we're going to dive deeper into how you can create your conversations in Treble thinking about your campaign objectives.
...
1. **Conversation objective**: Define the objective of the conversation. Some examples are:
    - Marketing your services or products. You can even measure the conversion rate of your campaigns. You can use the [Goal Block](/en/docs/build-with-treble/blocks/goal-block) functionality.
