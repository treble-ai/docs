...
En la sección de <a class="article-link" href="/es/docs/intro-to-treble/welcome"><p>Introducción a Treble</p><Icon icon="arrow-up-right-from-square" iconType="solid" /></a>, aprendiste sobre los conceptos clave de Treble como conversaciones, bloques, plantillas y más. Ahora, vamos a profundizar en cómo puedes crear tus conversaciones en Treble pensando en el objetivo de tus campañas.
...
1. **Objetivo de la conversación**: Define el objetivo de la conversación. Algunos ejemplos son:
    - Hacer marketing de tus servicios o productos. Puedes incluso medir la tasa de conversión de tus campañas. Puedes utilizar la funcionalidad de <a class="article-link" href="/es/docs/build-with-treble/blocks/goal-block"><p>Bloque Objetivo</p><Icon icon="arrow-up-right-from-square" iconType="solid" /></a>.
