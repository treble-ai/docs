...
Para crear una plantilla de mensaje, puedes revisar la sección de [¿Cómo crear una plantilla (HSM)?](/es/docs/meta/hsm-templates#como-usar-las-plantillas-hsm-en-treble).
