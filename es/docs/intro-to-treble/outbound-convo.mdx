...
Crear una conversación outbound es muy sencillo. Para comenzar, ingresa a tu cuenta de Treble. Toda conversación outbound debe iniciar con una plantilla de mensaje (HSM). Por lo tanto, primero debes crear una plantilla de mensaje.
