...
Para crear una plantilla de mensaje, puedes revisar la sección de <a class="article-link" href="/es/docs/meta/hsm-templates/intro#como-usar-las-plantillas-hsm-en-treble"><p>¿Cómo crear una plantilla (HSM)?</p><Icon icon="arrow-up-right-from-square" iconType="solid" /></a>.
