...
<Note>Cuando uses la API de WhatsApp Business, ten en cuenta algunas limitaciones. Estamos acostumbrados a que tenemos una aplicación, sea de WhatsApp o de WhatsApp Business en nuestro teléfono. Sin embargo, cuando usamos la API de WhatsApp Business, no tenemos una aplicación en nuestro teléfono. Adicionalmente, no podemos hacer llamadas o crear grupos de WhatsApp.</Note>
